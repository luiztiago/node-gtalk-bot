...
CXXFLAGS = ['-g']
CXXFLAGS_DEBUG = ['-g']
CXXFLAGS_ICU = ['-I/usr/local/Cellar/icu4c/4.4.1/include']
...
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_ICU = ['-headerpad_max_install_names', '', '-lpthread', '-lm', '', '', '-L/usr/local/Cellar/icu4c/4.4.1/lib', '-licui18n', '-licuuc', '-licudata', '', '-lpthread', '-lm']
